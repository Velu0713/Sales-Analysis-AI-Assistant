...
st.set_page_config(page_title="Sales Analysis AI Assistant — Chat + Insights",
                   layout="centered",
...
st.markdown("<div class='header'><h2 style='margin:0'>Sales Analysis AI Assistant — Chat + Insights</h2>"
